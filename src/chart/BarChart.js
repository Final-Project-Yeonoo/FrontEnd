       ...
       //chart height이 100%이기 때문이 chart를 덮는 마크업 요소에 height 설정
        ...
        <div style={{ width: '400px', height: '400px', margin: '0 auto' }}>
            ...
            <ResponsiveBar
                 ...
                 */
                data={[
                    { department: 'Finance', Finance: 5 },
                    { department: "HumanResources", HumanResources: 5 },
                ]}
                /**
                 * chart에 보여질 데이터 key (측정되는 값)
                 */
                keys={['Finance', 'HumanResources',]}
                /**
                 ...
                 * chart 색상
                 */
                colors={[ 'brown', 'orange']} // 커스터하여 사용할 때
