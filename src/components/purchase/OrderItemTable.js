...
const OrderItemTable = () => {
    ...
    const columns = [
        ...
        { field: 'itemOrderEnd', headerName: '마감기한', width: 100 },
        { field: 'trCompCode', headerName: '거래처코드', width: 200 },
        { field: 'trCompName', headerName: '거래처명', width: 200 },
        { field: 'empNo', headerName: '사원번호', width: 150 },
        { field: 'itemOrderReg', headerName: '등록시간', width: 100 },
