...
//                   value={selectedDept} // 선택된 부서명을 INPUT 태그의 value로 설정
//                   onClick={openModal}
//                   onChange={(e) => setSelectedDept(e.target.value)} // INPUT 값 변경 시 부서명 업데이트
//                   // onChange={(e) =>
//                   //   setUserValue({ ...userValue, deptCode: e.target.value }
//                 /> 
//                   <React.Fragment>
//                 <BasicModal open={modalVisible} close={closeModal} header="Modal heading">
